...
| GPUMode eigh kernel competition | (Mostly) autonomous system took 3rd in GPUMode's eigh kernel competition - 1,293 experiments over two weeks, 8.56x speedup over torch, with documented reward hacking and fixes carried into a real Shampoo training run 2.2x faster to quality | Eliana | [Blog](https://elianaive.com/posts/another-typical-autoresearch-post/) · [Tweet](https://x.com/EliaIsPosting/status/2083265398133145965) | [blog](https://elianaive.com/posts/another-typical-autoresearch-post/) |
